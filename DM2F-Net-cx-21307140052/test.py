...
args = {
    ...
    'snapshot': 'iter_40000_loss_0.01214_lr_0.000000'
    #'snapshot': 'iter_20000_loss_0.03232_lr_0.000000'
}
        ...
        for name, root in to_test.items():
            ...
            for idx, data in enumerate(dataloader):
                ...
                for i in range(len(fs)):
                    ...
                    ciede2000 = deltaE_ciede2000(rgb2lab(gt),rgb2lab(r))
                    ciede2000 = np.mean(ciede2000)
                    ciedes.append(ciede2000)
